...
{
    // Convert 007coin:// to 007coin:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("007coin://"))
    {
        uri.replace(0, 12, "007coin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "007Coin.lnk";
}
...
{
    return GetAutostartDir() / "007coin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("007Coin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  007coin-qt [" + tr("command-line options") + "]                     " + "\n";
...
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(171,223,255); border-left-style: solid; border-left-width: 6px; }"
