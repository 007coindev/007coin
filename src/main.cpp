...
unsigned int nStakeMinAge = 7 * 24 * 60 * 60; // 1 week
...
const string strMessageMagic = "007Coin Signed Message:\n";
...
static const int64_t nTargetTimespan = 24 * 60;  
